function [theta] = rslldmThetaFunc(phi, psi, bias, phiMean, thetaMean, psiMean, biasMean, phiPrec, thetaPrec, psiPrec, biasPrec, theta0, options, data, rdata, dataN, numDoc, numWord, numRating, dim)
