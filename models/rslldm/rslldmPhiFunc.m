function [phi] = rslldmPhiFunc(theta, psi, bias, phiMean, thetaMean, psiMean, biasMean, phiPrec, thetaPrec, psiPrec, biasPrec, phi0, options, data, rdata, dataN, numDoc, numWord, numRating, dim)
