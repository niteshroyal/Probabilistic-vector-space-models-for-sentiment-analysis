function [psi] = rslldmPsiFunc(theta, phi, bias, phiMean, thetaMean, psiMean, biasMean, phiPrec, thetaPrec, psiPrec, biasPrec, psi0, options, data, rdata, dataN, numDoc, numWord, numRating, dim)
