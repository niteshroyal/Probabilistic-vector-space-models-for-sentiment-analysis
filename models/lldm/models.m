function [] = models(datafile, startFoldNum, endFoldNum, useJointMutInf, priorAval, datatype, vecSpaceDim, maxiter, topN, numOfProcess)
    ...
    parfor x=startFoldNum:endFoldNum
        ...
        [theta, phi, bias] = lldm(phiPriorMean, thetaPriorMean, biasPriorMean, phiInit, thetaInit, biasInit, phiPrec, thetaPrec, biasPrec, options, dat, maxiter, x, impFeat);
    end
end
