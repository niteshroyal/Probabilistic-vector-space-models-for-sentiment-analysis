function [bias] = sslldmBiasFunc(theta, psi, phi, phiMean, thetaMean, psiMean, biasMean, phiPrec, thetaPrec, psiPrec, biasPrec, bias0, options, data, rdata, dataN, numDoc, numWord, numRating, dim)
